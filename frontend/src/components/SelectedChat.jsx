      ...
      <div className="flex-1 mb-[72px] overflow-y-auto">
        ...
        {messages.map((message) => (
          <div
            key={message._id}
            className={`chat ${
              // Dynamically set class based on message sender
              message.senderId === authUser._id ? "chat-end" : "chat-start" // Align message to the right if it's from the logged-in user, else left
            }`}
          >
