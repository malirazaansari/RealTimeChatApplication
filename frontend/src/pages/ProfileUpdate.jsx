        ...
        <div className="space-y-8 bg-base-300 p-6 rounded-xl">
          ...
          <div className="space-y-6">
            <div className="space-y-1.5">
              ...
              <p className="bg-base-200 px-4 py-2.5 border rounded-lg text-zinc-400">
                {authUser?.name}
              </p>
            </div>
          ...
          <div className="bg-base-300 mt-6 p-6 rounded-xl">
            <h2 className="mb-4 font-medium text-lg text-zinc-400">
              Account Information
            </h2>
            <div className="space-y-3 text-sm">
              <div className="flex justify-between items-center border-zinc-700 py-2 border-b text-zinc-400">
